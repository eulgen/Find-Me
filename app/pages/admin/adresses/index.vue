...
<template>
	<div class="h-full flex flex-col xl:flex-row gap-6">
		...
		<div class="w-full xl:w-[280px] shrink-0 flex flex-col gap-6">
			<div>
				<h1 class="text-2xl font-black text-[#1A237E] mb-1">Répertoire des Adresses</h1>
			...
			<div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 flex-1">
				...
				<div class="space-y-5">
					<div>
						...
						<select class="w-full text-sm bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-700 outline-none focus:border-[#1A237E]">
					...
					<div>
						...
						<input type="text" placeholder="Ex: Bastos" class="w-full text-sm bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-700 outline-none focus:border-[#1A237E] placeholder-gray-400" />
					</div>
					<div>
		...
		<div class="flex-1 flex flex-col gap-6 overflow-hidden">
							...
							>
								<td class="px-5 py-4">
									<div class="flex items-center gap-3">
										...
										<span class="text-sm font-black text-[#1A237E]">{{ addr.code }}</span>
									</div>
								</td>
								<td class="px-5 py-4">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6 h-[160px] shrink-0">
				...
				<div class="bg-[#0A0F2C] rounded-3xl p-6 text-white relative overflow-hidden shadow-lg">
					<div class="absolute -right-10 -bottom-10 w-32 h-32 bg-[#1A237E] rounded-full blur-2xl opacity-50"></div>
				...
				<div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm relative overflow-hidden flex flex-col justify-center items-center text-center">
					...
					<h3 class="text-lg font-black text-gray-800 mb-2 relative z-10">Aide à la Validation</h3>
					<p class="text-xs text-gray-500 mb-4 relative z-10 max-w-[200px]">Besoin de guides sur les nomenclatures de quartier ?</p>
					<button class="text-[#2E7D32] text-sm font-black hover:text-[#1B5E20] transition-colors flex items-center gap-1 relative z-10">
				...
				<div class="overflow-y-auto flex-1 p-5 space-y-6" style="scrollbar-width: none;">
					...
					<div>
						<div class="flex items-start justify-between mb-1">
							<h2 class="text-2xl font-black text-[#1A237E]">{{ selectedAddress.code }}</h2>
					...
					<div class="w-full h-32 bg-gray-200 rounded-2xl overflow-hidden relative">
						...
						<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#2E7D32] rounded-full shadow-lg border-2 border-white z-10"></div>
					...
					<div>
						...
						<div class="space-y-4 relative before:absolute before:inset-y-0 before:left-[5px] before:w-px before:bg-gray-200">
							<div class="relative pl-6">
								...
								<p class="text-[10px] text-gray-500 mt-0.5">14 Mars 2024 à 10:30</p>
							</div>
							<div class="relative pl-6">
								...
								<p class="text-[10px] text-gray-400 mt-0.5">12 Mars 2024 à 09:15</p>
							</div>
						</div>
					</div>
