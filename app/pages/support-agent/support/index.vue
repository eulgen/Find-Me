<!--
  @file app/pages/support-agent/support/index.vue
  @description Page de gestion des tickets de support client pour l'Agent Support — design glassmorphism à ton uni émeraude (#00bc7d) et bleu nuit (#0A0D1A) avec squelettes (SkeletonUI).
-->
...
<template>
	<div class="space-y-6 max-w-7xl mx-auto w-full animate-in fade-in duration-500 text-slate-900 dark:text-white">
		...
		<div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
			<div>
				<p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Espace Agent / Support Client</p>
