...
<template>
	<section
		class="py-20 px-6 max-w-5xl mx-auto text-center space-y-8"
		id="final-cta-promo"
	>
		<div
			class="bg-white dark:bg-slate-900 rounded-[36px] border-4 border-[#1A237E] dark:border-[#2E7D32] p-10 md:p-14 shadow-[10px_10px_0px_0px_#2E7D32] space-y-6"
			id="promo-box"
		>
			<span
				class="bg-[#FFD5D0] border-2 border-[#1A237E] text-[#1A237E] uppercase text-xs font-black tracking-widest px-4 py-1.5 rounded-full inline-block"
			>
				Accès Citoyen
			</span>

			<h2
				class="text-3xl md:text-5xl font-black text-[#1A237E] dark:text-white tracking-tight max-w-xl mx-auto leading-tight"
			>
				Prêt à rendre votre adresse visible au monde entier ?
			</h2>

			<p
				class="text-[#1A237E]/80 dark:text-gray-300 text-sm md:text-base max-w-lg mx-auto font-normal"
			>
				Rejoignez les centaines de Camerounais qui simplifient la livraison de
				colis, la venue de taxis et les interventions de secours à Douala et
				Yaoundé.
			</p>
