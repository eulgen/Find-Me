  ...
  <div v-if="isOpen" class="fixed inset-0 z-50 bg-[#1A237E]/45 backdrop-blur-sm flex items-center justify-center p-4 shadow-2xl" id="auth-modal-overlay">
    ...
    >
      ...
      <div v-if="authStep === 'login'" class="space-y-4" id="auth-form-wrapper">
        ...
        <div class="flex border-b border-[#1A237E]/10" id="auth-tabbar" role="tablist" aria-label="Type de connexion">
        ...
        <form @submit="handleSimulatedClaim" class="space-y-4" id="auth-form-body">
          <div v-if="authMode === 'signup'" class="space-y-1.5" id="auth-input-username-group">
            ...
            <input type="text" required class="w-full text-xs px-3.5 py-3 rounded-xl border-2 border-[#1A237E]/20 bg-white text-[#1A237E] font-bold focus:border-[#2E7D32] focus:outline-none" placeholder="Takam Jules" v-model="authUsername" />
          </div>
          ...
          <div class="space-y-1.5" id="auth-input-email-group">
            ...
            <input type="email" required class="w-full text-xs px-3.5 py-3 rounded-xl border-2 border-[#1A237E]/20 bg-white text-[#1A237E] font-bold focus:border-[#2E7D32] focus:outline-none" placeholder="mail@gmail.com" v-model="authEmail" />
          </div>
